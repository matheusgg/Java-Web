...
public class Categoria implements Serializable{
	...
	/*
	 * O atributo 'fetch = FetchType.EAGER' é responsável por fazer a carga completa da
	 * do ArrayList, se fosse utilizado 'FetchType.LAZY', o Hibernate carregaria somente
	 * os filhos que serão exibidos na árvore no momento da consulta
	 * 
	 * Já o atributo 'CascadeType.REMOVE' remove todos os filhos e netos caso a categoria
	 * seja excluída
	 */
