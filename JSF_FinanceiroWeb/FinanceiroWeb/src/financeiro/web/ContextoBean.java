...
public class ContextoBean implements Serializable{
	...
	public List<Locale> getIdiomas() {
		...
		/*
		 * Aqui, são recuperados e listados todos os idiomas suportados pela
		 * aplicação definidos no faes-config.xml
		 */
	...
	public void setIdiomaUsuario(String idioma) {
		...
		/*
		 * Esta é responsável por trocar o idioma da aplicação, aqui é
		 * recuperada a árvore da vizualização e setado o locale padrão
		 */
