...
public class Cliente implements Serializable {
	...
	@OneToOne
	/*
	 * A annotation @PrimaryKeyJoinColumn é utilizada em relacionamentos um-para-um quando
	 * temos uma entidade fraca e outra forte, neste caso, a chave primária da entidade
	 * cliente (forte) será também a chave da entidade endereço (fraca).
	 */
	 ...
	 * pode carregar cliente. É um relacionamento bidirecional utlizado no relacionamento
	 * um-para um
	 */
